...
--
-- Host: localhost
-- Tempo de geração: 17-Abr-2022 às 05:44
...
INSERT INTO `bibliotecas` (`leitor_id`, `livro_id`, `titulo`) VALUES
(1, 10, 'Favoritos'),
(1, 12, 'Favoritos'),
(2, 12, 'Legais'),
(2, 21, 'Legais'),
...
INSERT INTO `posses` (`leitor_id`, `livro_id`) VALUES
(126, 9),
(120, 16),
(218, 18),
(222, 19),
...
ALTER TABLE `bibliotecas`
  ...
  ADD KEY `fk_biblioteca_livro` (`livro_id`);
...
--
-- Índices para tabela `posses`
--
ALTER TABLE `posses`
  ADD PRIMARY KEY (`leitor_id`,`livro_id`),
  ADD KEY `fk_leitor_livro` (`livro_id`);
...
--
ALTER TABLE `bibliotecas`
  ADD CONSTRAINT `fk_biblioteca_livro` FOREIGN KEY (`livro_id`) REFERENCES `livros` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
-- Limitadores para a tabela `posses`
--
ALTER TABLE `posses`
  ADD CONSTRAINT `fk_leitor_livro` FOREIGN KEY (`livro_id`) REFERENCES `livros` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_livro_leitor` FOREIGN KEY (`leitor_id`) REFERENCES `leitores` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
