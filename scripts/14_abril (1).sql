...
CREATE TABLE `livros` (
  ...
  `biblioteca_id` int(11) unsigned NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_autor_id` (`autor_id`),
  KEY `fk_biblioteca_id` (`biblioteca_id`),
  CONSTRAINT `fk_autor_id` FOREIGN KEY (`autor_id`) REFERENCES `autores` (`id`),
  CONSTRAINT `fk_biblioteca_id` FOREIGN KEY (`biblioteca_id`) REFERENCES `bibliotecas` (`id`)
...
-- Dump completed on 2022-04-14 22:21:39
